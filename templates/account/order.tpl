            ...
            <div class="col-md-4">
                <div class="box p-3">
                    ...
                    {% if order.address %}
                        ...
                        {# Se a data existir e não estiver vazia, mostre o prazo #}
{% if order.estimated_delivery_date and order.estimated_delivery_date != '' %}
<p class="font-small">
    <svg class="icon-inline mr-1 icon-w svg-icon-primary"><use xlink:href="#clock"/></svg> 
    {{'Prazo de Entrega' | translate}}: 
    <strong>
       {{ order.estimated_delivery_date | i18n_date('%d/%m/%Y') }}
    </strong>
</p>
{% endif %}
                        <p class="font-small">
